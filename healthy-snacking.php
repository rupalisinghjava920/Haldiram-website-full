    ...
    <div class="row">
        ...
        <div class="col-12 col-md-8">
            <div class="card-container">
                ...
                <div class="card-row">  
                    <div class="card-1">
                        <img src="images/webp.png" alt="Product 1">
                        <h2>Mint Makhana</h2>
                        <div>
                            <span>₹150.00</span>
                            <span><i class="fa fa-heart" aria-hidden="true"></i></span> 
                            <span><a href="snacks-add-details.php"><i class="fa fa-plus-square" aria-hidden="true"></i></a></span>
                        </div>
                    </div>

                    <div class="card-1">
                        <img src="images/webp1.png" alt="Product 2">
                        <h2>Magic Makhana Salt N Butter</h2>
                        <div>
                            <span>₹150.00</span>
                            <span><i class="fa fa-heart" aria-hidden="true"></i></span> 
                            <span><a href="snacks-add-details.php"><i class="fa fa-plus-square" aria-hidden="true"></i></a></span>
